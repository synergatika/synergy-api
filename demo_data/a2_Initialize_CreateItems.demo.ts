...
describe("Create Offers", () => {
  describe("by Bread & Roses (defaultPartner_4)", () => {
  ...
  describe("by Action Plus (defaultPartner_6)", () => {
    var _date_1 = new Date();
  ...
  describe("by Cooperative Publications (defaultPartner_5)", () => {
    var _date_1 = new Date();
  ...
  describe("by Syn Allois (defaultPartner_3)", () => {
    var _date_1 = new Date();
