...
var imagesLocation = path.join(__dirname, './assets');
const lang = 'en-En';
...
var partner_a = {
  ...
  authToken: '',
  _id: '',
  updatedImageFile: "partner_4.jpg",
...
var offer_a = {
  ...
  cost: 80,
  expiresAt: _newDate4,
  imageFile: "offer_1.jpg",
  updatedImageFile: 'offer_4.jpg'
}
...
var post_c = {
  ...
  contentFiles: ['post_2.jpg', 'event_1.jpg'],
